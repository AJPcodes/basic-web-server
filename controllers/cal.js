"use strict";
const cal = function(yearParam, monthParam) {
...
module.exports.getCal = (req, res) => {

    const output = cal(req.params.year,req.params.month);
    res.render('calDisplay', {calString: output});
}